...
public class RequestBookValidator implements Validator {
    ...
    public boolean supports(Class<?> clazz) {
        ...
        boolean result = RequestBook.class.isAssignableFrom(clazz);
    ...
    public void validate(Object target, Errors errors) {
        RequestBook requestBook = (RequestBook) target;

        System.out.println("validate() 호출 : " + requestBook);

        // 바인딩한 객체에 대한 다양한 검증 수행.
//        String user = qna.getUser();
...
//        }
        ...
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "req_bookname", "subject 글 제목은 필수입니다");
